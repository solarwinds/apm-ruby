...
module SolarWindsOTelAPM
  ...
  class TraceContext
    ...
    def initialize(headers = {})
      ...
      return unless traceparent.is_a?(String) && SolarWindsOTelAPM::TraceString.valid?(traceparent)
      ...
      if @tracestate
        ...
        @tracestring = SolarWindsOTelAPM::TraceString.replace_span_id_flags(@traceparent, @sw_member_value)
      end
